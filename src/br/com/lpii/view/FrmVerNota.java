...
public class FrmVerNota extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_nota.setBackground(new java.awt.Color(0, 153, 51));
        txt_nota.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txt_nota.setForeground(new java.awt.Color(0, 153, 51));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // Ao carregar o frame, imprime nota do aluno
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVerNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVerNota().setVisible(true);
            }
        });
    }
